...
class Frikin_Allies_Admin_Post_Types
{
	...
	public static function new_cpt_ally()
	{
		...
		$opts['labels']['singular_name']                = _x('Ally', 'Post type singular name', 'frikin-allies');
		$opts['labels']['menu_name']                    = _x('Allies', 'Admin Menu text', 'frikin-allies');
		$opts['labels']['name_admin_bar']               = _x('Ally', 'Add New on Toolbar', 'frikin-allies');
		$opts['labels']['add_new']                      = __('Add New', 'frikin-allies');
		$opts['labels']['add_new_item']                 = __('Add New Ally', 'frikin-allies');
		$opts['labels']['new_item']                     = __('New Ally', 'frikin-allies');
		$opts['labels']['edit_item']                    = __('Edit Ally', 'frikin-allies');
		$opts['labels']['view_item']                    = __('View Ally', 'frikin-allies');
		...
		$opts['labels']['featured_image']               = _x('Ally Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'frikin-allies');
		...
		$opts['labels']['filter_items_list']            = _x('Filter ally list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'frikin-allies');
		$opts['labels']['items_list_navigation']        = _x('Ally list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'frikin-allies');
		$opts['labels']['items_list']                   = _x('Ally list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'frikin-allies');
